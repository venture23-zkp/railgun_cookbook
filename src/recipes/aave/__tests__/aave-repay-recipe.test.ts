...
const repayAmount = 1_000000n;
const nftTokenId = '0';
const interestRepayMode = 2;

describe('aave-repay-recipe', () => {
  before(() => {
    setRailgunFees(
      networkName,
      MOCK_SHIELD_FEE_BASIS_POINTS,
  ...
  it('Should create aave-repay-recipe', async () => {
    ...
    expect(output.feeERC20AmountRecipients).to.deep.equal([
      {
        ...
        amount: getUnshieldFee(networkName, repayAmount),
    ...
    expect(output.crossContractCalls).to.deep.equal([
      ...
      {
        to: ownableContractAddress,
        data: '',
      },
    ]);
      ...
      outputERC20Amounts: [
        {
          ...
          minBalance: getUnshieldedAmountAfterFee(networkName, repayAmount),
      ...
      spentERC20Amounts: [
        {
          tokenAddress: aaveTokenData.tokenAddress,
          decimals: aaveTokenData.decimals,
          amount: getUnshieldedAmountAfterFee(networkName, repayAmount),
    ...
    expect(output.stepOutputs[3]).to.deep.equal({
      name: 'AAVEv3 Repay',
      description: 'Repays the specified ERC20 token from Account Contract(AC) to Aave V3',
      crossContractCalls: [
        {
          to: ownableContractAddress,
          // todo: `data` value changes after using actual deployed ethereum contracts
