...
import { DaiAddCollateralToVault } from '../../steps/dai-minting/dai-add-collateral-to-vault-step';
...
export class MintDaiRecipe extends Recipe {
  readonly config: RecipeConfig = {
    name: 'Mint DAI token',
    description: 'Depsoit collateral and mint DAI token after an empty vault is opened',
